...
export const useMoviePayment = ({
  ...
  const queryKey = [
    "paymentHistory",
    { movieId, seats, user, organizer, tranId },
  ];
  ...
  const fetchPaymentHistory = async () => {
    ...
    const body = JSON.stringify({ movieId, seats, user, organizer, tranId });

    const res = await fetch(`/api/payment/movie/history`, {
      method: "POST",
