...
export async function POST(req) {
  ...
  console.log("seat", body.seatQuantity);
  ...
  try {
    ...
    const payload = {
      ...
      shipping_method: "NO",
      success_url: `${process.env.NEXT_PUBLIC_BASE_URL}/api/payment/event/success`,
      fail_url: `${process.env.NEXT_PUBLIC_BASE_URL}/api/payment/unsuccess?ticket=event`,
      cancel_url: `${process.env.NEXT_PUBLIC_BASE_URL}/api/payment/unsuccess?ticket=event`,
    };
