      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
          >
            <h3 className="text-xl font-bold mb-2 text-[#950101]">Total Organizers</h3>
            <p className="text-3xl font-semibold text-gray-800">{stats.totalOrganizers}</p>
          </motion.div>
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
          >
            <h3 className="text-xl font-bold mb-2 text-[#950101]">Total Events</h3>
            <p className="text-3xl font-semibold text-gray-800">{stats.totalEvents}</p>
          </motion.div>
        </div>
