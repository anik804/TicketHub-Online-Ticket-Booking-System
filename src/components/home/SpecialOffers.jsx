      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {events.map((event, index) => (
          <motion.div
            ...
            key={index}
            className="p-[1px] rounded-2xl shadow-md hover:shadow-secondary/30 hover:scale-102 hover:rotate-3 custom-transition relative overflow-hidden "
          >
            ...
            <div className="flex visible flex-col items-center justify-center bg-base-200 rounded-[16px] relative z-2 p-4">
